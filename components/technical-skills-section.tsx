...
export function TechnicalSkillsSection() {
  ...
  const duplicatedFrontend = [...frontendSkills, ...frontendSkills, ...frontendSkills, ...frontendSkills, ...frontendSkills, ...frontendSkills]
  const duplicatedBackend = [...backendSkills, ...backendSkills, ...backendSkills, ...backendSkills, ...backendSkills]
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <AnimatedSection animation="fade-up" delay={100}>
            <h2 className="text-4xl font-black text-[#EAE8F3] mb-4">Mes Compétences Techniques</h2>
        ...
        <div className="space-y-16">
          {/* Frontend Skills - Scrolling Right to Left */}
          <AnimatedSection animation="fade-up" delay={200}>
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-[#A77B9E] mb-2">Développement Frontend</h3>
              <div className="w-16 h-1 bg-[#A77B9E] mx-auto"></div>
            </div>

            <div className="relative overflow-hidden">
              <div className="flex animate-scroll-right-to-left-fast whitespace-nowrap">
          ...
          <AnimatedSection animation="fade-up" delay={300}>
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-[#A77B9E] mb-2">Développement Backend</h3>
              <div className="w-16 h-1 bg-[#A77B9E] mx-auto"></div>
            </div>
